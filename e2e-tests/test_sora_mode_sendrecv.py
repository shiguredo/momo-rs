...
def test_sendrecv(
    ...
    with (
        ...
        client1_inbound_rtp = [stat for stat in client1_stats if stat.get("type") == "inbound-rtp"]
        ...
        client2_inbound_rtp = [stat for stat in client2_stats if stat.get("type") == "inbound-rtp"]
